                ...
                {uploadedImage ? (
                    <div className='w-full h-full relative'>
                        ...
                        <button
                            type="button"
                            tabIndex={-1}
                            className="absolute top-2 right-2 bg-black bg-opacity-70 font-bold text-white rounded-full p-1 hover:bg-white hover:text-black focus:outline-none transition-colors duration-200"
                            onClick={e => {
                                e.preventDefault();
                                e.stopPropagation();
                                handleRemoveClick(e);
                    ...
                    <div className="flex flex-col items-center justify-center pt-5 pb-6">
                        ...
                        <p className="mb-2 text-sm text-gray-500 text-center">
                            <span className="font-semibold ">[선택] 전신 사진 업로드</span><br />
                            <span className="font-base text-xs">클릭하거나 이미지를 끌어다 놓으세요</span>
                        </p>
                    </div>
                )}
