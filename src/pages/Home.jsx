    ...
    <div>
      ...
      <section className="relative w-full h-screen">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center z-10">
          <h1 className="text-white text-5xl font-bold text-center leading-tight mb-5">
            고민할 필요 없이<br />
            FitU로 간편하게
          </h1>
          ...
          {/* TODO 개인 정보 등록 페이지 이동 */}
          <Link
            to="/"
            className="shadow-md cursor-pointer shadow px-10 py-2 bg-white text-black text-base font-bold rounded mt-2 text-center"
          >
            시작하기
          </Link>
        </div>
      ...
      <section className="bg-white w-full h-screen py-16 flex flex-col items-center ">
        <img src="/logo.png" alt="FitU Logo" className="w-32 mb-8" /> {/* 로고 경로에 맞게 수정 */}
